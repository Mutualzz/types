# Contributing to @mutualzz/types

Thanks for wanting to help with **@mutualzz/types**.

Contributions are welcome. Redistributing unofficial builds or hosting a
competing Mutualzz service is still not allowed — see [`LICENSE`](https://github.com/Mutualzz/types/blob/master/LICENSE).
